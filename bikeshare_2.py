...
# TO DO: get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs
    ...
    while city_name.lower() not in CITY_DATA:
        city_name = input("\nWhat is the name of the city to analyze data for? (E.g. Input either chicago, new york city, washington)\n")
...
# TO DO: get user input for month (all, january, february, ... , june)
    ...
    while month_name.lower() not in MONTH_DATA:
        month_name = input("\nWhat is the name of the month to filter data for? (E.g. Input either 'all' to apply no month filter or january, february, ... , june)\n")
...
# TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    ...
    while day_name.lower() not in DAY_DATA:
        day_name = input("\nWhat is the name of the day to filter data for? (E.g. Input either 'all' to apply no day filter or monday, tuesday, ... sunday)\n")
